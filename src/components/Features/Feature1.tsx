const Feature1 = () => {
	return (
		<div className="px-10 py-14 md:px-24 lg:px-40 lg:pb-24 ">
			...
			<div className="space-y-5 mt-6 block md:flex md:flex-wrap md:space-y-0 md:gap-y-12 md:justify-between md:mt-10 lg:mt-16 lg:gap-x-0">
				<div className="flex md:w-1/2">
					...
					<div className="flex-1 pl-4">
						...
						<p className="text-gray-500 lg:max-w-xl md:w-11/12">
							...
							elit. Totam, cumque tenetur. Sunt eum blanditiis
							non? Unde voluptatum suscipit consequatur quas
