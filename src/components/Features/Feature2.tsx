const Feature2 = () => {
	return (
		<div className="py-14 lg:pb-24">
			<p className=" px-10 md:pl-10 lg:px-40 text-4xl font-bold mb-2 text-primary lg:text-center lg:mb-5">
				Lorem ipsum dolor site
			</p>
			<p className="text-gray-600 text-xl lg:text-center lg:max-w-3xl lg:mx-auto px-10 md:pr-0 md:pl-10">
				Lorem ipsum dolor sit amet consectetur adipisicing elit. Minima
				impedit eos dicta odio cum aperiam earum velit quae itaque amet
				aliquid autem
			</p>
			<div className="flex flex-wrap md:flex-nowrap px-10 md:px-0">
				<div className="space-y-5 mt-6 block md:flex md:flex-wrap md:space-y-0 md:gap-y-12 md:justify-between md:mt-10 lg:mt-16 lg:gap-x-0 md:w-1/2 md:pl-10 lg:pl-24">
					{[1, 1, 1, 1].map((e) => {
						return (
							<div className="flex md:w-1/2 lg:w-full">
								<svg
                ...
                <div className="mt-8 md:w-1/2 md:pl-10 md:flex md:items-center lg:py-10">
                   <img 
